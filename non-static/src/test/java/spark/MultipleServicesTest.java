...
public class MultipleServicesTest {
    ...
    private SparkTestUtil firstClient;
    private SparkTestUtil secondClient;

    @Before
    public void setup() throws Exception {
        firstClient = new SparkTestUtil(1235);
    ...
    private Service igniteFirstService() {

        Service http = ignite()
                .port(1235); // I give the variable the name 'http' for the code to make sense when adding routes.
    ...
    private Service igniteSecondService() {
