...
public class GenericIntegrationTest {
    ...
    private final String NOT_FOUND_BRO = "Not found bro";

    private final Logger LOGGER = LoggerFactory.getLogger(GenericIntegrationTest.class);
    ...
    private void registerEchoRoute(final String routePart) {
        svc.get("/tworoutes/" + routePart + "/:param", (q, a) -> {
